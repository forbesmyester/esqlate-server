...
< Connection: keep-alive
<
{"status":"complete","location":"http:/localhost:8803/result/customer_search_by_name_only/Uz9rkntC9reP"}
```
...
**Note:** If you wish to circumvent the Queue you can use the below which will give you immediate results:
